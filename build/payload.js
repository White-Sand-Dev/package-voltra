...
export const ensurePayloadWithinBudget = (compressedPayload) => {
    ...
    if (bytes > EFFECTIVE_JSON_BUDGET) {
        throw new Error(`[Voltra] Compressed payload size ${bytes}B exceeds safe budget ${EFFECTIVE_JSON_BUDGET}B (ActivityKit hard cap ${MAX_ACTIVITYKIT_BYTES}B). You need to reduce the complexity of your UI.`);
    }
};
