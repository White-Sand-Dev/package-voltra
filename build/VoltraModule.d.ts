...
export interface VoltraModuleSpec {
     ...
     */
    startAndroidLiveUpdate(payload: string, options: {
        updateName?: string;
        channelId?: string;
    }): Promise<string>;
    /**
     ...
     */
    updateAndroidWidget(widgetId: string, jsonString: string, options?: {
        deepLinkUrl?: string;
    }): Promise<void>;
    /**
     ...
     */
    requestPinGlanceAppWidget(widgetId: string, options?: {
        previewWidth?: number;
