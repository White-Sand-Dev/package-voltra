 ...
 * ```
 */
export const updateAndroidWidget = async (widgetId, variants, options) => {
 ...
 * ```
 */
export const reloadAndroidWidgets = async (widgetIds) => {
 ...
 * ```
 */
export const clearAndroidWidget = async (widgetId) => {
 ...
 * ```
 */
export const clearAllAndroidWidgets = async () => {
