 ...
 * ```
 */
export const useAndroidLiveUpdate = (variants, options) => {
 ...
 * ```
 */
export const startAndroidLiveUpdate = async (variants, options) => {
 ...
 * ```
 */
export const updateAndroidLiveUpdate = async (notificationId, variants, options) => {
    const payload = renderAndroidLiveUpdateToString(variants);
 ...
 * ```
 */
export const stopAndroidLiveUpdate = async (notificationId) => {
 ...
 * ```
 */
export const isAndroidLiveUpdateActive = (updateName) => {
 ...
 * ```
 */
export async function endAllAndroidLiveUpdates() {
