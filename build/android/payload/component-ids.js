 ...
 */
export const ANDROID_COMPONENT_NAME_TO_ID = {
 ...
 */
export const ANDROID_COMPONENT_ID_TO_NAME = {
 ...
 */
export function getAndroidComponentId(name) {
 ...
 */
export function getAndroidComponentName(id) {
