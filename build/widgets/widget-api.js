 ...
 * ```
 */
export const updateWidget = async (widgetId, variants, options) => {
 ...
 * ```
 */
export const reloadWidgets = async (widgetIds) => {
    if (!assertRunningOnApple())
        return Promise.resolve();
 ...
 * ```
 */
export const clearWidget = async (widgetId) => {
    if (!assertRunningOnApple())
        return Promise.resolve();
 ...
 * ```
 */
export const scheduleWidget = async (widgetId, entries) => {
    if (!assertRunningOnApple())
        return Promise.resolve();
